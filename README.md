...
The MMED annotations and splits will be made available for research use upon acceptance of the manuscript. Please see [📥 Data Access](#-data-access) for the application procedure.
